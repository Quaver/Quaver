...
namespace UnityStandardAssets.ImageEffects
{
    ...
    internal class GlobalFog : PostEffectsBase
    {
        ...
        private void OnRenderImage(RenderTexture source, RenderTexture destination)
        {
            ...
            _fogMaterial.SetVector("_HeightParams", new Vector4(height, FdotC, paramK, heightDensity * 0.5f));
            _fogMaterial.SetVector("_DistanceParams", new Vector4(-Mathf.Max(startDistance, 0.0f), 0, 0, 0));
            ...
            _fogMaterial.SetVector("_SceneFogMode", new Vector4((int)sceneMode, useRadialDistance ? 1 : 0, 0, 0));
            ...
            if (distanceFog && heightFog)
                ...
                pass = 2; // height only
            CustomGraphicsBlit(source, destination, _fogMaterial, pass);
        }
