	...
	public class BeatmapCacheIndex
	{
		...
		public static void CreateDatabase()
		{
			...
			using(IDbConnection dbConnection = new SqliteConnection(connectionString))
			{
				...
				{
					string query = "CREATE TABLE if not exists \"main\".\"beatmaps\" (\"id\" INTEGER PRIMARY KEY  AUTOINCREMENT  NOT NULL  UNIQUE , \"directory\" TEXT NOT NULL , \"path\" TEXT NOT NULL  UNIQUE , \"beatmapsetid\" INTEGER NOT NULL , \"beatmapid\" INTEGER NOT NULL , \"artist\" TEXT NOT NULL , \"title\" TEXT NOT NULL , \"difficulty\" TEXT NOT NULL , \"rank\" TEXT NOT NULL , \"status\" INTEGER NOT NULL  DEFAULT 0, \"lastplayed\" DATETIME NOT NULL  DEFAULT CURRENT_DATE, \"stars\" INTEGER NOT NULL)";
					...
					using (IDataReader reader = dbCmd.ExecuteReader())
					{
						...
						while (reader.Read())
						{
							...
							CachedBeatmap loadedBeatmap = new CachedBeatmap(reader.GetString(1), reader.GetString(2), reader.GetInt32(3), reader.GetInt32(4),
																...
																reader.GetInt32(9), DateTime.Now, reader.GetFloat(11));
