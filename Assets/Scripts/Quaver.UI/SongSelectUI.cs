...
namespace Quaver.UI
{
    public class SongSelectUI : MonoBehaviour
    {
        ...
        public void Start()
        {
            ...
            {
                SongList[i] = new SongSelectObject(0, SongSelect, SelectionSet.transform, ObjectYSize, i, this.GetComponent<SongSelectUI>());
                int curPos = i;
        ...
        public void Clicked(int pos, bool subSelection)
        {
            if (!subSelection)
            {
                ...
                {
                    DifficultyList[i] = new SongSelectObject(i+1, DiffSelect, SelectionSet.transform, SongList[pos].posY - 75 - newSongPos, i, this.GetComponent<SongSelectUI>());
