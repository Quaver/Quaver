...
# License
Most of the content in this section of the repository is licensed under CC-BY-NC 4.0. See the [License]() file for more information regarding this. In short, you may use the contents in the docmentation section of the repository as long as it is not in a commercial manner.
