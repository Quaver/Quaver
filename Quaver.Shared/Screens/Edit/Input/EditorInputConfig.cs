...
namespace Quaver.Shared.Screens.Edit.Input
{
    ...
    public class EditorInputConfig
    {
        ...
        [YamlIgnore] public static Dictionary<KeybindActions, KeybindList> DefaultKeybinds = new Dictionary<KeybindActions, KeybindList>()
        {
            ...
            {SeekForwardsAndMove, new KeybindList(new[] {new Keybind(KeyModifiers.Alt, Keys.Up), new Keybind(KeyModifiers.Alt, Keys.I)})},
            {SeekBackwardsAndMove, new KeybindList(new[] {new Keybind(KeyModifiers.Alt, Keys.Down), new Keybind(KeyModifiers.Alt, Keys.K)})},
            ...
            {SeekToStartAndSelect, new KeybindList(new[] {new Keybind(KeyModifiers.Shift, Keys.Home), new Keybind(KeyModifiers.Shift, Keys.U)})},
            {SeekToEndAndSelect, new KeybindList(new[] {new Keybind(KeyModifiers.Shift, Keys.End), new Keybind(KeyModifiers.Shift, Keys.O)})},
