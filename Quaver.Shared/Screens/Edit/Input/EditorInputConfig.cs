...
namespace Quaver.Shared.Screens.Edit.Input
{
    ...
    public class EditorInputConfig
    {
        ...
        [YamlIgnore] public static Dictionary<KeybindActions, KeybindList> DefaultKeybinds = new Dictionary<KeybindActions, KeybindList>()
        {
            ...
            {SeekForwards1msWithSelection, new KeybindList(KeyModifiers.Shift, Keys.OemPeriod)},
            {SeekForwards1msWithMove, new KeybindList(KeyModifiers.Alt, Keys.OemPeriod)},
            {SeekBackwards1ms, new KeybindList(Keys.OemComma)},
            {SeekBackwards1msWithSelection, new KeybindList(KeyModifiers.Shift, Keys.OemPeriod)},
            {SeekBackwards1msWithMove, new KeybindList(KeyModifiers.Alt, Keys.OemPeriod)},
            {SeekToStartOfSelection, new KeybindList(Keys.U)},
            {SeekToStartOfSelectionWithMove, new KeybindList(KeyModifiers.Alt, Keys.U)},
            {SeekToEndOfSelection, new KeybindList(Keys.O)},
            {SeekToEndOfSelectionWithMove, new KeybindList(KeyModifiers.Alt, Keys.O)},
            {SeekToBeginning, new KeybindList(Keys.Home)},
            {SeekToBeginningWithSelection, new KeybindList(KeyModifiers.Shift, Keys.Home)},
            {SeekToBeginningWithMove, new KeybindList(KeyModifiers.Alt, Keys.Home)},
            {SeekToEnd, new KeybindList(Keys.End)},
            {SeekToEndWithSelection, new KeybindList(KeyModifiers.Shift, Keys.End)},
            {SeekToEndWithMove, new KeybindList(KeyModifiers.Alt, Keys.End)},
