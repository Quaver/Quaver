...
namespace Quaver.Shared.Screens.Edit.Plugins
{
    ...
    public static class EditorPluginUtils
    {
        ...
        /// <summary>
        ///     Casts the <see cref="HitSounds"/> parameter to the <see cref="int"/>.
        /// </summary>
        /// <remarks><para>
        /// Required because having <see cref="HitSounds"/> as <see cref="UserData"/> makes it impossible to perform
        /// arithmetic operations, or get the underlying representation for said operation.
        /// </para></remarks>
        /// <param name="hitSounds">The <see cref="HitSounds"/> to cast.</param>
        /// <returns>The <see cref="int"/> cast of the <see cref="HitSounds"/> parameter.</returns>
        public static int HitSoundsToInt(HitSounds hitSounds) => (int)hitSounds;

        /// <summary>
        ///     Casts the <see cref="int"/> parameter to the <see cref="HitSounds"/>.
        /// </summary>
        /// <remarks><para>
        /// Required because having <see cref="HitSounds"/> as <see cref="UserData"/> makes it impossible to perform
        /// arithmetic operations, or get the underlying representation for said operation.
        /// </para></remarks>
        /// <param name="hitSounds">The <see cref="int"/> to cast.</param>
        /// <returns>The <see cref="HitSounds"/> cast of the <see cref="int"/> parameter.</returns>
        public static HitSounds IntToHitSounds(int hitSounds) => (HitSounds)hitSounds;
