...
{
    public class EditorChangePlayfieldColorDialog : YesNoDialog
    {
        ...
        /// <summary>
        /// </summary>
        public EditorChangePlayfieldColorDialog() : base("CHANGE PLAYFIELD COLOR",
            "Enter a new RGB color for your playfield...(default: 24,24,24)")
        {
            NewColor = new Color(ConfigManager.EditorPlayfieldColorR.Value, ConfigManager.EditorPlayfieldColorG.Value, ConfigManager.EditorPlayfieldColorB.Value);
        ...
        private void CreateTextbox()
        {
            ...
            Textbox = new Textbox(new ScalableVector2(Panel.Width * 0.86f, 50), FontManager.GetWobbleFont(Fonts.LatoBlack),
                20, val, "Enter RGB color (ex: 24,24,24)...", OnSubmit)
            {
                Parent = Panel,
        ...
        private void OnSubmit(string s)
        {
            ...
            ConfigManager.EditorPlayfieldColorR.Value = newColor.R;
            ConfigManager.EditorPlayfieldColorG.Value = newColor.G;
            ConfigManager.EditorPlayfieldColorB.Value = newColor.B;
        }
    }
}