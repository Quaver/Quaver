...
{
    public class DialogChangeLayerColor : YesNoDialog
    {
        ...
        /// <summary>
        /// </summary>
        public DialogChangeLayerColor(EditorLayerInfo layer, EditorActionManager manager, Qua workingMap) : base("CHANGE LAYER COLOR",
