...
namespace Quaver.Shared.Screens.Edit.UI.Preview
{
    public class EditorMapPreview : SelectMapPreviewContainer
    {
            ...
            int height, IAudioTrack track = null, Qua qua = null) : base(isPlayTesting, activeLeftPanel, height, track, qua)
        {
            ...
            ActionManager.ScrollSpeedFactorLaneMaskBatchChanged += OnScrollSpeedFactorLaneMaskBatchChanged;
        ...
        private void OnScrollSpeedFactorLaneMaskBatchChanged(object sender, EditorChangedScrollSpeedFactorLaneMaskBatchEventArgs e) => Refresh();
