...
namespace Quaver.Shared.Screens.Results.UI.Tabs.Overview.Graphs
{
    ...
    {
        public GraphSelectionDropdown() : base(ResultsLocalization.Get("Graph:"), 18, new Dropdown(GetDropdownItems(),
            new ScalableVector2(150, 38), 18, ColorHelper.HexToColor($"#10C8F6"), GetSelectedIndex()))
        {
        ...
        {
            ResultsLocalization.Get("Deviance"),
            ResultsLocalization.Get("Accuracy"),
            ResultsLocalization.Get("Health"),
