...
namespace Quaver.Shared.Screens.Music.UI.Controller.Search.Dropdowns
{
    ...
    {
        public MusicControllerSortDropdown() : base("SORT BY: ", 20, new Dropdown(GetDropdownItems(),
            new ScalableVector2(160, 38), 20, ColorHelper.HexToColor($"#ffe76b"), GetSelectedIndex()))
        {
