...
{
    public class MultiplayerPlayerOptionItem : PoolableSprite<IMultiplayerPlayerOption>
    {
        /// <inheritdoc />
        /// <summary>
        /// </summary>
        ...
        public MultiplayerPlayerOptionItem(MultiplayerPlayerOptionsDialog dialog, PoolableScrollContainer<IMultiplayerPlayerOption> container, IMultiplayerPlayerOption item, int index)
        ...
        /// <param name="item"></param>
        /// <param name="index"></param>
        public override void UpdateContent(IMultiplayerPlayerOption item, int index)
        {
        }
    }
}