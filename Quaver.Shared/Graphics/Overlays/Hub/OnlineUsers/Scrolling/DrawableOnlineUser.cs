...
namespace Quaver.Shared.Graphics.Overlays.Hub.OnlineUsers.Scrolling
{
    public sealed class DrawableOnlineUser : PoolableSprite<User>
    {
        ...
        {
            Clan = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.LatoBold), "", 22)
            {
                Parent = this,
                Alignment = Alignment.TopLeft,
        ...
        {
            Username = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.LatoBold), "Loading...", 22)
            {
                Parent = this,
                Alignment = Alignment.TopLeft,
                X = Flag.X + Flag.Width + 8,
        ...
        {
            Status = new SpriteTextPlus(FontManager.GetWobbleFont(Fonts.LatoBold), "Idle", 20)
            {
                Parent = this,
