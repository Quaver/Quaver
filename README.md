...
# LICENSE
The code in this repository is licensed under the [Creative Commons Attribution-NonCommercial 4.0 International (CC BY-NC 4.0)](https://tldrlegal.com/license/creative-commons-attribution-noncommercial-4.0-international-(cc-by-nc-4.0)#summary). This does **not** include any images or sound files used within this repository. In short, you can use the code in this repository as long as it is not in a commercial manner.
