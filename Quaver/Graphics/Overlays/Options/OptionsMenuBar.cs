...
namespace Quaver.Graphics.Overlays.Options
{
    internal class OptionsMenuBar
    {
        ...
        /// </summary>
        private Dictionary<OptionsType, QuaverTextButton> SectionButtons { get; }
        ...
        internal OptionsMenuBar(OptionsOverlay overlay)
        {
            ...
            SectionButtons = new Dictionary<OptionsType, QuaverTextButton>();
        }
        ...
        internal void AddButton(OptionsType type, string name, Texture2D icon)
         {
             // Create the button
             SectionButtons[type] = new QuaverTextButton(new Vector2(70, 30), name)
             {
                Parent = Container,
