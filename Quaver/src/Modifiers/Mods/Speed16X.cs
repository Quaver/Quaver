...
{
    internal class Speed16X : IMod
    {
        /// <summary>
        ///     The name of the mod.
        /// </summary>
        public string Name { get; set; } = "1.6x";

        /// <summary>
        ///     The identifier of the mod.
        /// </summary>
        public ModIdentifier ModIdentifier { get; set; } = ModIdentifier.Speed16X;
        ...
        /// </summary>
        public string Description { get; set; } = "Sets the song's speed to 1.6x";
        ...
        public ModIdentifier[] IncompatibleMods { get; set; } =
        {
            ...
            ModIdentifier.Speed17X, ModIdentifier.Speed18X, ModIdentifier.Speed19X, ModIdentifier.Speed20X
        };
