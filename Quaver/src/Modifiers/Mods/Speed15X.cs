...
namespace Quaver.Modifiers.Mods
{
    internal class Speed15X : IMod
    {
        ...
        ///     The name of the mod.
        /// </summary>
        public string Name { get; set; } = "1.5x";
        ...
        /// </summary>
        public string Description { get; set; } = "Sets the song's speed to 1.5x";
        ...
        public ModIdentifier[] IncompatibleMods { get; set; } =
        {
            ...
            ModIdentifier.Speed11X, ModIdentifier.Speed12X, ModIdentifier.Speed13X, ModIdentifier.Speed14X, 
