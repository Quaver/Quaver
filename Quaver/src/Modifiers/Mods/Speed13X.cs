...
{
    internal class Speed13X : IMod
    {
        /// <summary>
        ///     The name of the mod.
        /// </summary>
        public string Name { get; set; } = "1.3x";

        /// <summary>
        ///     The identifier of the mod.
        /// </summary>
        public ModIdentifier ModIdentifier { get; set; } = ModIdentifier.Speed13X;
        ...
        /// </summary>
        public string Description { get; set; } = "Sets the song's speed to 1.3x";
        ...
        public ModIdentifier[] IncompatibleMods { get; set; } =
        {
            ...
            ModIdentifier.Speed11X, ModIdentifier.Speed12X, ModIdentifier.Speed14X, ModIdentifier.Speed15X,
