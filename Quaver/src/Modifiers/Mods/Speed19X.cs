...
{
    internal class Speed19X : IMod
    {
        /// <summary>
        ///     The name of the mod.
        /// </summary>
        public string Name { get; set; } = "1.9x";

        /// <summary>
        ///     The identifier of the mod.
        /// </summary>
        public ModIdentifier ModIdentifier { get; set; } = ModIdentifier.Speed19X;
        ...
        /// </summary>
        public string Description { get; set; } = "Sets the song's speed to 1.9x";
        ...
        public ModIdentifier[] IncompatibleMods { get; set; } =
        {
            ...
            ModIdentifier.Speed16X, ModIdentifier.Speed17X, ModIdentifier.Speed18X, ModIdentifier.Speed20X
        };
