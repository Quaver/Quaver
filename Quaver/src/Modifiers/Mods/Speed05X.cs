...
{
    internal class Speed05X : IMod
    {
        /// <summary>
        ///     The name of the mod.
        /// </summary>
        public string Name { get; set; } = "0.5x";
        ...
        /// </summary>
        public string Description { get; set; } = "Sets the song's speed to 0.5x";
        ...
        {
            ModIdentifier.Speed06X, ModIdentifier.Speed07X, ModIdentifier.Speed08X, ModIdentifier.Speed09X,
