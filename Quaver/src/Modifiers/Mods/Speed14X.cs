...
{
    internal class Speed14X : IMod
    {
        /// <summary>
        ///     The name of the mod.
        /// </summary>
        public string Name { get; set; } = "1.4x";

        /// <summary>
        ///     The identifier of the mod.
        /// </summary>
        public ModIdentifier ModIdentifier { get; set; } = ModIdentifier.Speed14X;
        ...
        /// </summary>
        public string Description { get; set; } = "Sets the song's speed to 1.4x";
        ...
        public ModIdentifier[] IncompatibleMods { get; set; } =
        {
            ...
            ModIdentifier.Speed11X, ModIdentifier.Speed12X, ModIdentifier.Speed13X, ModIdentifier.Speed15X,
