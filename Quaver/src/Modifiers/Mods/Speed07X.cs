...
{
    internal class Speed07X : IMod
    {
        /// <summary>
        ///     The name of the mod.
        /// </summary>
        public string Name { get; set; } = "0.7x";

        /// <summary>
        ///     The identifier of the mod.
        /// </summary>
        public ModIdentifier ModIdentifier { get; set; } = ModIdentifier.Speed07X;
        ...
        /// </summary>
        public string Description { get; set; } = "Sets the song's speed to 0.7x";
        ...
        {
            ModIdentifier.Speed05X, ModIdentifier.Speed06X, ModIdentifier.Speed08X, ModIdentifier.Speed09X,
