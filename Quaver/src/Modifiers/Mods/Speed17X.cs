...
{
    internal class Speed17X : IMod
    {
        /// <summary>
        ///     The name of the mod.
        /// </summary>
        public string Name { get; set; } = "1.7x";

        /// <summary>
        ///     The identifier of the mod.
        /// </summary>
        public ModIdentifier ModIdentifier { get; set; } = ModIdentifier.Speed17X;
        ...
        /// </summary>
        public string Description { get; set; } = "Sets the song's speed to 1.7x";
        ...
        public ModIdentifier[] IncompatibleMods { get; set; } =
        {
            ...
            ModIdentifier.Speed16X, ModIdentifier.Speed18X, ModIdentifier.Speed19X, ModIdentifier.Speed20X
        };
