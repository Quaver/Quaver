...
{
    internal class Speed08X : IMod
    {
        /// <summary>
        ///     The name of the mod.
        /// </summary>
        public string Name { get; set; } = "0.8x";

        /// <summary>
        ///     The identifier of the mod.
        /// </summary>
        public ModIdentifier ModIdentifier { get; set; } = ModIdentifier.Speed08X;
        ...
        /// </summary>
        public string Description { get; set; } = "Sets the song's speed to 0.8x";
        ...
        {
            ModIdentifier.Speed05X, ModIdentifier.Speed06X, ModIdentifier.Speed07X, ModIdentifier.Speed09X,
