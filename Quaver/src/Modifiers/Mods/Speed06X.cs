...
{
    internal class Speed06X : IMod
    {
        /// <summary>
        ///     The name of the mod.
        /// </summary>
        public string Name { get; set; } = "0.6x";
        ...
        /// </summary>
        public string Description { get; set; } = "Sets the song's speed to 0.6x";
        ...
        {
            ModIdentifier.Speed05X, ModIdentifier.Speed07X, ModIdentifier.Speed08X, ModIdentifier.Speed09X,
