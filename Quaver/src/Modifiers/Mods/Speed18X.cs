...
{
    internal class Speed18X : IMod
    {
        /// <summary>
        ///     The name of the mod.
        /// </summary>
        public string Name { get; set; } = "1.8x";
        ...
        /// </summary>
        public string Description { get; set; } = "Sets the song's speed to 1.8x";
        ...
        public ModIdentifier[] IncompatibleMods { get; set; } =
        {
            ...
            ModIdentifier.Speed16X, ModIdentifier.Speed17X, ModIdentifier.Speed19X, ModIdentifier.Speed20X
        };
