...
{
    internal class Speed11X : IMod
    {
        /// <summary>
        ///     The name of the mod.
        /// </summary>
        public string Name { get; set; } = "1.1x";

        /// <summary>
        ///     The identifier of the mod.
        /// </summary>
        public ModIdentifier ModIdentifier { get; set; } = ModIdentifier.Speed11X;
        ...
        /// </summary>
        public string Description { get; set; } = "Sets the song's speed to 1.1x";
        ...
        public ModIdentifier[] IncompatibleMods { get; set; } =
        {
            ...
            ModIdentifier.Speed12X, ModIdentifier.Speed13X, ModIdentifier.Speed14X, ModIdentifier.Speed15X,
