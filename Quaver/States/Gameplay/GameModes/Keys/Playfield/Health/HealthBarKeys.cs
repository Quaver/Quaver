        ...
        public override void Initialize(IGameState state)
        {
            ...
            switch (BarAlignment)
            {
                ...
                case HealthBarKeysAlignment.LeftStage:
                    ...
                    BackgroundBar.PosX = newLeftPosX - BackgroundBar.SizeX / 2f - 8;
                    ForegroundBar.PosX = newLeftPosX - ForegroundBar.SizeX / 2f - 8;
                    break;
                case HealthBarKeysAlignment.RightStage:
                    ...
                    BackgroundBar.PosX = newRightPosX + BackgroundBar.SizeX / 2f + 8;
                    ForegroundBar.PosX = newRightPosX + ForegroundBar.SizeX / 2f + 8;
                    break;
            }
        }
    }
